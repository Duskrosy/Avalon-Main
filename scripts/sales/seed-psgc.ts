...
async function main() {
  ...
  const postalEntries: Array<PostalEntry & { name: string }> = [
    ...
    // CAR · Abra (zone 28xx, Phlpost). All 26 munis with confirmed codes.
    { region: "CAR", name: "Bangued", postal: "2800" },
    { region: "CAR", name: "Dolores", postal: "2801" },
    { region: "CAR", name: "Lagangilang", postal: "2802" },
    { region: "CAR", name: "Tayum", postal: "2803" },
    { region: "CAR", name: "Bucay", postal: "2805" },
    { region: "CAR", name: "Peñarrubia", postal: "2806" },
    { region: "CAR", name: "Langiden", postal: "2807" },
    { region: "CAR", name: "Pidigan", postal: "2808" },
    { region: "CAR", name: "San Isidro", postal: "2809" },
    { region: "CAR", name: "Manabo", postal: "2810" },
    { region: "CAR", name: "Villaviciosa", postal: "2811" },
    { region: "CAR", name: "Pilar", postal: "2812" },
    { region: "CAR", name: "San Quintin", postal: "2814" },
    { region: "CAR", name: "Boliney", postal: "2815" },
    { region: "CAR", name: "Daguioman", postal: "2816" },
    { region: "CAR", name: "Luba", postal: "2817" },
    { region: "CAR", name: "Bucloc", postal: "2818" },
    { region: "CAR", name: "Sallapadan", postal: "2819" },
    { region: "CAR", name: "Malibcong", postal: "2820" },
    { region: "CAR", name: "Lacub", postal: "2821" },
    { region: "CAR", name: "Licuan-Baay", postal: "2822" },
    { region: "CAR", name: "Tubo", postal: "2823" },
    { region: "CAR", name: "Lagayan", postal: "2824" },
    { region: "CAR", name: "Danglas", postal: "2825" },
    { region: "CAR", name: "La Paz", postal: "2826" },
    // ── Region I — Ilocos ───────────────────────────────────────────
